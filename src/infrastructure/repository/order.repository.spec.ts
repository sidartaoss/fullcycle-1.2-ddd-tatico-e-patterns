...
describe("Order repository tests.", () => {
    ...
    it("should create a new order", async () => {
        ...
        const address = new Address("Rua Abc Def", 123, "90001002", "Novo Hamburgo");
        customer.changeAddress(address);
        await customerRepository.create(customer);

        const productRepository = new ProductRepository();
        const product = new Product("123", "Product 1", 9.90);
    ...
    it("should update an order and update an order item", async () => {
        ...
        const address2 = new Address("Rua Abc Hij", 999, "91111002", "Caxias do Sul");
    ...
    it("should find all orders", async () => {
        ...
        const address1 = new Address("Rua Abc Def", 123, "90001002", "Novo Hamburgo");
        customer1.changeAddress(address1);
        await customerRepository.create(customer1);

        const productRepository = new ProductRepository();
        const product1 = new Product("123", "Product 1", 9.90);
        ...
        const address2 = new Address("Rua Abc Jhi", 999, "99991002", "Caxias do Sul");
        customer2.changeAddress(address2);
        await customerRepository.create(customer2);

        const product2 = new Product("333", "Product 2", 19.90);
